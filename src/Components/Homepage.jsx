...
export default function Homepage() {
  ...
  return (
    ...
    <div className="container mt-[128px] px-0 max-w-full inline-block  text-white">
      <h1 className={`text-5xl text-white mx-auto flex justify-center opacity-0transition-all ease-in-out duration-1000 ${load==='isLoaded' ? 'opacity-100' : ''}`}>
        <div className="animate-bounce w-6 h-6 rounded-full bg-blue-700 relative top-10"></div> 
        <span className="text-white font-bold">Generative AI NFT Minter</span>
        <div className="animate-bounce w-6 h-6 rounded-full bg-pink-700"></div></h1>
